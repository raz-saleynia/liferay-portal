...
public class ResourcePermissionFinderImpl
	...
	public int countByC_N_S_P_R_A(
		...
		Long count = (Long)PartitionFinderCacheUtil.getResult(partId,
		...
		try {
			...
			PartitionFinderCacheUtil.putResult(
				partId, ResourcePermissionPersistenceImpl.FINDER_PATH_COUNT_BY_C_N_S_P_R_A,
				finderArgs, count);
