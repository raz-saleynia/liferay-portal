...
public class EntityCacheImpl implements CacheRegistryItem, EntityCache {
    ...
    private static final String  _USE_EXTERNAL_CACHE = "endplay.external.cache.use.for.EntityCache";
    private static final String  _EXTERNAL_CACHE_NAMES = "endplay.external.cache.EntityCache.list";
    private static boolean _useExternalCache;
    private static Set<String> _externalCacheNames;

    private MultiVMPool _multiVMPool;
    private MultiVMPool _externalCache;
