...
public abstract class BaseTemplateParser implements TemplateParser {
	...
	protected void populateTemplateContext(TemplateContext templateContext)
		...
		templateContext.put("targetGroupId", getTargetGroupId());
	...
	private final static Log _log = LogFactoryUtil.getLog(BaseTemplateParser.class);

	public long getTargetGroupId() {
		return GetterUtil.getLong(_tokens.get("target_group_id"));
	}
}