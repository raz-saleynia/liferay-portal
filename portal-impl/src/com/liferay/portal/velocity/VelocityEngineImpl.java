...
public class VelocityEngineImpl implements VelocityEngine {
	...
	public void init() throws Exception {
		...
		//******************************************
		// set property for velocity macro
		
		boolean allowInlineReplaceGlobal = !PropsValues.VELOCITY_ENGINE_RESOURCE_MANAGER_CACHE_ENABLED;
		String allowInlineReplaceGlobalStr = PropsUtil.get(VELOCITY_MACRO_ALLOW_INLINE_REPLACE_GLOBAL);
		if (StringUtils.isNotEmpty(allowInlineReplaceGlobalStr)) {
			allowInlineReplaceGlobal = GetterUtil.getBoolean(allowInlineReplaceGlobalStr);
		}
		extendedProperties.setProperty(
				org.apache.velocity.app.VelocityEngine.VM_PERM_ALLOW_INLINE_REPLACE_GLOBAL,
				String.valueOf(allowInlineReplaceGlobal));
		
		extendedProperties.setProperty(
				org.apache.velocity.app.VelocityEngine.VM_PERM_INLINE_LOCAL,
				String.valueOf(PropsUtil.get(VELOCITY_MACRO_LOCAL_SCOPE_ENABLE)));
		//******************************************
		// EXT Override End
		//******************************************
	...
	public static final String VELOCITY_MACRO_LOCAL_SCOPE_ENABLE = "velocity.macro.local.scope.enable";
	public static final String VELOCITY_MACRO_ALLOW_INLINE_REPLACE_GLOBAL = "velocity.macro.allow.inline.replace.global";
