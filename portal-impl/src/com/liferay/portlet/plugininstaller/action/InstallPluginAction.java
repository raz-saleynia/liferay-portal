...
public class InstallPluginAction extends PortletAction {
	...
	public void processAction(
		...
		boolean hasPermission = PortletPermissionUtil.contains(permissionChecker,
				0, 0, PortletKeys.ADMIN_PLUGINS, ActionKeys.ACCESS_IN_CONTROL_PANEL, true);

		hasPermission = hasPermission || permissionChecker.isOmniadmin();
		if (!hasPermission) {
			SessionErrors.add(
