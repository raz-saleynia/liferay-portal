...
public class AssetTagLocalServiceImpl extends AssetTagLocalServiceBaseImpl {
	public static final char[] INVALID_CHARACTERS = new char[] { CharPool.NEW_LINE, CharPool.RETURN };
	@Override
	...
	protected void validate(String name) throws PortalException {
		if (!this.isValidWord(name)) {
			throw new AssetTagException(
					StringUtil.merge(
							INVALID_CHARACTERS, StringPool.SPACE),
	...
	private static Log _log = LogFactoryUtil.getLog(AssetTagLocalServiceImpl.class);
}