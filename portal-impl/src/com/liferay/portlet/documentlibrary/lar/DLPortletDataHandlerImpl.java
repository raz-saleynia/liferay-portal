	...
	public static void exportFileEntry(
		...
		if (!portletDataContext.isPerformDirectBinaryImport()) {
			...
			try {
				...
				{
					binPath = CDNStoreUtil.getFileEntryBinPath(portletDataContext.getPortletPath(PortletKeys.DOCUMENT_LIBRARY), fileEntry);
				}
			    /*END ADDED*/
			...
			if (existingDLFileEntryType == null) {
				...
				importedDLFileEntryType =
						DLFileEntryTypeLocalServiceUtil.addFileEntryType(
								...
								dlFileEntryType.getDescription(), ddmStructureIdsArray,
								serviceContext);
			}
			else {
				if (!isFileEntryTypeGlobal(
					...
					DLFileEntryTypeLocalServiceUtil.updateFileEntryType(
							...
							name, dlFileEntryType.getDescription(),
