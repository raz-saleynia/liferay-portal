...
public class FileEntryUtil extends LiferayBase {
	...
	public static InputStream getContentStream(FileEntry fileEntry)
		...
		{
			String filePath = (String)fileEntry.getFileVersion().getExpandoBridge().getAttribute(DocumentLibraryDataConstants.CUSTOM_FIELD_PATH) +  StoreConstants.PATH_SEPARATOR + (String)fileEntry.getFileVersion().getExpandoBridge().getAttribute(DocumentLibraryDataConstants.CUSTOM_FILENAME);
			return DLStoreUtil.getFileAsStream(
					fileEntry.getCompanyId(), repositoryId,
					filePath, fileEntry.getVersion());
		}
		/*END ADDED*/
		else
		{
