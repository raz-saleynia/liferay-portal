...
public class ViewAction extends PortletAction {
	...
	public void processAction(
		...
		long parentGroupId = ParamUtil.getLong(actionRequest, "parentGroupId", 0);
		...
		String redirect = getRedirect(
			themeDisplay, layouts, groupId, privateLayoutParam, parentGroupId);
	...
	public ActionForward strutsExecute(
		...
		long parentGroupId = ParamUtil.getLong(request, "parentGroupId", 0);
	...
	protected String getRedirect(
			...
			String privateLayoutParam, long parentGroupId)
		throws Exception {
